...
int main()
{
    ...
    /* Read data from file*/
    string filename = "crowd_temperature_40.txt";
    int lines = CountLines(filename);
    int task = 0;
    ofstream result;
    result.open("result_40_withupdate.csv", ios::out);
    result << "Task"
           << ","
           << "Observation truth"
           << ","
    ...
    ofstream Agent135;
    Agent135.open("Agent135_40_wu.csv", ios::out);
    Agent135 << "AgebtID"
             << ","
             << "qvalue"
             << ","
             << "profit" << endl;
    ofstream Agent352;
    Agent352.open("Agent352_40_wu.csv", ios::out);
    Agent352 << "AgebtID"
             << ","
             << "qvalue"
             << ","
             << "profit" << endl;
    ofstream Agent8;
    Agent8.open("Agent8_40_wu.csv", ios::out);
    Agent8 << "Agent8"
           << ","
           << "qvalue"
           << ","
