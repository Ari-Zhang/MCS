...
int random0[] = {0};
vector<int> maliciousUsers(random30, random30 + 30);
...
int main()
{
    ...
    int task = 0;
    ofstream result;
    result.open("result_30_ro_ua.csv", ios::out);
    result << "Task"
           << ","
           << "Observation truth"
           << ","
    ...
    ofstream Agent135;
    Agent135.open("Agent135_30_ro_ua.csv", ios::out);
    Agent135 << "AgebtID"
             << ","
             << "qvalue"
             << ","
             << "profit" << endl;
    ofstream Agent352;
    Agent352.open("Agent352_30_ro_ua.csv", ios::out);
    Agent352 << "AgebtID"
             << ","
             << "qvalue"
             << ","
             << "profit" << endl;
    ofstream Agent358;
    Agent358.open("Agent358_30_ro_ua.csv", ios::out);
    Agent358 << "Agent358"
             << ","
             << "qvalue"
             << ","
